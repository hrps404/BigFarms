  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Big Farms</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="/pages/seedsInventory.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Seed Name</th>
                    ...
                    <tr>
                      ...
                      <td>
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0" style="text-transform:capitalize;"><?php echo $data['category']??''; ?></p>
                            </div>
                      </td>

                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $data['expiry']??''; ?></span>
                      </td>
                      
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold "><?php echo $data['quantity']??''; ?></span>
                      </td>
                      ...
                      <td class="align-middle">
                        <button class="btn btn-link text-secondary mb-0" aria-haspopup="true" data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="fa fa-ellipsis-v text-xs" aria-hidden="true"></i>
                        </button>
                        <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                          <li><a class="dropdown-item border-radius-md" href="javascript:;">Order</a></li>
                          <li><a class="dropdown-item border-radius-md" href="javascript:;">Delete</a></li>
                          <li><a class="dropdown-item border-radius-md" href="javascript:;">Update</a></li>
                        </ul>
                    </td>
                    </tr>
          ...
          <div class="modal-body p-0">
            <div class="card card-plain">
              ...
              <div class="card-body pb-3">
                <form role="form text-left" action ="addData.php" method="POST" name="addSeed">
                    ...
                    <div class="form-group">
                        <div class="col col-sm-offset-3">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="seedWay" value="Harvested" /> Harvested
                            </label>

                            <label class="radio-inline">
                                <input type="radio" name="seedWay" value="Ordered" /> Ordered
                            </label>
                        </div>
                    </div>
                </div>
